...
$result_a = mysqli_query($mysqli, "SELECT * FROM `parking` WHERE `name` = '136'");
...
<body>
    <div class="container-xs">
        ...
        <div class="col-xs-6 pic">
            ...
            <img src="/img/1_136.jpg" alt="1" class="img-fluid" >
            <img src="/img/2_136.jpg" alt="2" class="img-fluid" >
            <img src="/img/3_136.jpg" alt="3" class="img-fluid">
            <img src="/img/4_136.jpg" alt="4" class="img-fluid" >
