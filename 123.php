...
$result_a = mysqli_query($mysqli, "SELECT * FROM `parking` WHERE `name` = '123'");
    ...
    <div class="container-xs">
        <div class="col-xs-6 ml-3">
            <div class="map">
                ...
                <img src="/img/first_floor_empty_25_left.jpg" alt="схема паркинга слева">
            </div>
        </div>
        ...
        <div class="col">
            ...
            <img src="/img/1_123.jpg" alt="1" class="img-fluid">
            <img src="/img/2_123.jpg" alt="2" class="img-fluid">
            <img src="/img/3_123.jpg" alt="3" class="img-fluid">
            <img src="/img/4_123.jpg" alt="4" class="img-fluid">
